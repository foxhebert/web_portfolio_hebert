        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <h1>Hebert Gonzales</h1>
                    <div class="page-scroll" >
                        <p class="job-title">Full Stack Junior Developer</p>
            <!--             <a href="#contact" class="btn btn-fill " hidden="hidden">Hire me</a> -->
                ...
                <div class="col-md-6 text-right">
                    <img src="assets/img/hebert-img.jpg" alt="alex-vidal">
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <p>Hello! I'm Hebert, a full stuck developer, a C# enthusiast, and a guy slighty obsessed for code quality. Also I'm a co-founder of pykod.com. I’m currently available for freelance work. If you have a project that you want to get started or think you need my help with something, then get in touch.</p>
